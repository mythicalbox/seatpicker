...
window.findBestSeat = function () {
  console.log(document.getElementById("seatdata").value);
  var loadedSeatData = JSON.parse(document.getElementById("seatdata").value);
  var columns = loadedSeatData.venue.layout.columns; // assumption made that only available seats are included in data

  var result = Object.keys(loadedSeatData.seats).sort(function (keyA, keyB) {
    var seatA = loadedSeatData.seats[keyA];
    var seatB = loadedSeatData.seats[keyB];
    var row1 = seatA.row;
    var row2 = seatB.row; // console.log(seatA, seatB);
    ...
    if (row1 < row2) {
      ...
      // same row, now check which is closer to aisle
      // console.log("same row");
      var col1 = seatA.column;
      var col2 = seatB.column;
      ...
      if (distanceFromMidpoint(midpoint, col1) < distanceFromMidpoint(midpoint, col2)) {
        ...
        console.log(midpoint, col1, col2); // console.log("here2");
  ...
  console.log(result);
  console.log(seatData.seats[result[0]]);
  var resultObj = document.getElementById("result");
  resultObj.innerText = result[0];
};
...
/******/ });
//# sourceMappingURL=application-c7fa1fd6066b6ae9aa43.js.map